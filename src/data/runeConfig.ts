...
export const fieldConfig: readonly FieldConfig[] = [
  { key: 'arms', label: '武伤', suffix: '%', min: 0, step: 0.1, help: '红色符文武器伤害' },
  { key: 'rate', label: '爆率', suffix: '%', min: 0, max: 100, step: 0.1, help: '红色符文暴击率' },
  { key: 'crit', label: '爆伤', suffix: '%', min: 0, step: 0.1, help: '红色符文暴击伤害' },
  { key: 'main', label: '紫色主武器', suffix: '%', min: 0, step: 0.1, help: '紫色符文主武器数值' },
